...
shapes = c(23,15,17,16,25)
cols = c('forestgreen','blue2','purple','goldenrod','firebrick3')
perm = 1:5 # experiment by permuting the symbol and color assignment
...
# generate plot
ggsave(l_p,file = '../../Figures/lambda_scores.pdf',height = 7)
...
# generate plot
ggsave(K_p,file = '../../Figures/K_scores.pdf',height = 7)
