...
score_dt = as.data.table(expand.grid(type = c('lambda','K'), obs = models, pr = models))
...
save(score_dt,K_scores,NEst_Kscore,perm_sc_K,NEst_lambdascore,lambda_scores,perm_sc_l, file = 'scores.RData')
